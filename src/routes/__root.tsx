...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Real-time IPL intelligence powered by AI, live momentum tracking, and predictive narrative analysis." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "The Scriptwriter's Revenge" },
      { property: "og:description", content: "Real-time IPL intelligence powered by AI, live momentum tracking, and predictive narrative analysis." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "The Scriptwriter's Revenge" },
      { name: "twitter:description", content: "Real-time IPL intelligence powered by AI, live momentum tracking, and predictive narrative analysis." },
